...
use Esgi\Store\Model\Locator;
use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Framework\Exception\LocalizedException;
use Magento\TestFramework\Inspection\Exception;

class Save extends \Esgi\Store\Controller\Adminhtml\Locator
{
    /**
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Esgi\Store\Model\Locator $model */
            $model = $this->_objectManager->create(\Esgi\Store\Model\Locator::class)->load($id);
            if (!$model->getId() && $id) {
